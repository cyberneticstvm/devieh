        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card p-4 mb-4">
                    <div class="row mb-3">
                        <div class="col-12">
                            <h4 class="text-success font-weight-bold">Create Customer</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6 col-md-6">
                                ...
                                {{ html()->text('name', old('name'))->class('form-control')->attribute('autocomplete', 'false')->placeholder('Customer Name') }}
                                @error('name')
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                {{ html()->text('address', old('address'))->class('form-control')->attribute('autocomplete', 'false')->placeholder('Address') }}
                                @error('address')
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                {{ html()->text('contact_person_name', old('contact_person_name'))->class('form-control')->attribute('autocomplete', 'false')->placeholder('Contact Person Name') }}
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                {{ html()->text('contact_person_number', old('contact_person_number'))->class('form-control')->attribute('autocomplete', 'false')->placeholder('Contact Person Number') }}
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                {{ html()->select('delivery_method', dMethods(), old('delivery_method'))->class('form-control select2')->attribute('autocomplete', 'false')->placeholder('Select') }}
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                {{ html()->number('credit_limit', old('credit_limit'))->class('form-control')->attribute('autocomplete', 'false')->placeholder('0.00') }}
                                @error('credit_limit')
