                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-2 col-md-6">
                                ...
                                {{ html()->number('price', $product->price)->class('form-control')->attribute('autocomplete', 'false')->placeholder('0.0') }}
                                @error('price')
                            ...
                            <div class="col-lg-2 col-md-6">
                                ...
                                {{ html()->number('tax_percentage', $product->tax_percentage)->class('form-control')->attribute('autocomplete', 'false')->placeholder('0.0') }}
