                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-3 col-md-6">
                                ...
                                {{ html()->select($name = 'from_branch', $value = $branches, $transfer->from_branch)->attribute('id', 'from_branch')->attribute('data-category', 'store')->class('form-control')->attribute('required', 'true') }}
                                @error('from_branch')
