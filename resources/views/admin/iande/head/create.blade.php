        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card p-4 mb-4">
                    <div class="row mb-3">
                        <div class="col-12">
                            <h4 class="text-success font-weight-bold">Create Head</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                {{ html()->select('category', array('Income' => 'Income', 'Expense' => 'Expense', 'Other' => 'Other'), old('category'))->class('form-control select2')->placeholder('Select') }}
                                @error('category')
