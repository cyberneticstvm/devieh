        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card p-4 mb-4">
                    <div class="row mb-3">
                        <div class="col-12">
                            <h4 class="text-success font-weight-bold">Create Camp</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6 col-md-6">
                                ...
                                {{ html()->text('name', old('name'))->class('form-control')->attribute('autocomplete', 'false')->placeholder('Camp Name') }}
                                @error('name')
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                {{ html()->date('from_date', old('from_date') ?? date('Y-m-d'))->class('form-control appdate appTime')->attribute('autocomplete', 'false') }}
                                @error('from_date')
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                {{ html()->date('to_date', old('to_date') ?? date('Y-m-d'))->class('form-control appdate appTime')->attribute('autocomplete', 'false') }}
                                @error('to_date')
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                {{ html()->text('venue', old('venue'))->class('form-control')->attribute('autocomplete', 'false')->placeholder('Venue') }}
                                @error('venue')
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                {{ html()->text('cordinator', old('cordinator'))->class('form-control')->attribute('autocomplete', 'false')->placeholder('Co-ordinator') }}
                                @error('cordinator')
