        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card p-4 mb-4">
                    ...
                    <div class="card-body">
                        {{ html()->form('PUT', route('product.update', $product->id))->class('')->open() }}
                        <div class="row g-3">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                {{ html()->select($name = 'eligible_for_commission', $value = array('Yes' => 'Yes', 'No' => 'No'), $product->eligible_for_commission)->class('form-control select2')->placeholder('Select') }}
