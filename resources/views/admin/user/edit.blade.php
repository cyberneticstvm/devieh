        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card p-4 mb-4">
                    <div class="row mb-3">
                        <div class="col-12">
                            <h4 class="text-success font-weight-bold">Update User</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        {{ html()->form('PUT', route('user.update', $user->id))->class('')->open() }}
                        <div class="row g-3">
                            <div class="col-lg-6 col-md-6">
                                <label class="form-label req" for="name">Full Name</label>
                                {{ html()->text('name', $user->name)->class('form-control')->attribute('autocomplete', 'false')->placeholder('Full Name') }}
                                @error('name')
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                {{ html()->text('username', $user->username)->class('form-control')->attribute('autocomplete', 'false')->placeholder('Username') }}
                                @error('username')
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                {{ html()->text('email', $user->email)->class('form-control')->attribute('autocomplete', 'false')->placeholder('Email') }}
                                @error('email')
                            ...
                            <div class="col-lg-2 col-md-4">
                                ...
                                {{ html()->select($name = 'mobile_login', $value = array('' => 'No', '1' => 'Yes'), $user->mobile_login)->class('form-control select2') }}
                            </div>
                        </div>
